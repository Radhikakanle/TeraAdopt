        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <div class="sidebar-header-wrapper">
                	<h4 class="menu-text" style="color: red; width: 100px; margin: 0px auto"><%=session.getAttribute("currentProject").toString()%></h4>
                </div>
                <!-- Sidebar Menu -->
                <ul class="nav sidebar-menu">
                	<li class="active open">
                        ...
                        <ul class="submenu" id="projectsList"></ul>
                	</li>
                	<li>                		
                		<a href="#" class="menu-dropdown">
                    ...
                    <c:forEach var="rp" items="${reportpage}">
                    	<li class="reportsLi"  data-report-page="${rp.pageName}"> 
                        	...
                        	<a href="#" class="menu-dropdown">
                        		<span class="menu-text">${rp.name}</span>
                        	</a>
                        </li>
                    </c:forEach>  		
            ...
            <div class="page-content">            	
                ...
                <div class="page-header position-relative">
                    <div class="header-title">
                    	<h1>Project Dashboard - <%=session.getAttribute("currentProject").toString()%></h1>
        			</div>
        		</div>
        		<!-- Page Body -->
                <div class="page-body">
                	...
                	<div class="row">
                		<div class="col-xs-12">
                			...
                			<div id="planningDiv">
                				<div class="row">
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="sprintReport">
                						<div class="widget">
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="velocityChart">
                						<div class="widget">
                							<div class="widget-header ">
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="releaseBurndown">
                						<div class="widget">
                							<div class="widget-header ">
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="sprintSummary">
                						<div class="widget">
                							<div class="widget-header ">
                			...
                			<div id="buildDiv">
                				<div class="row">
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="buildDetails">
                						<div class="widget">
                							<div class="widget-header ">
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="buildGraph">
                						<div class="widget">
                							<div class="widget-header ">
                			...
                			<div id="codeQualityDiv">
                				<div class="row">
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="cASummaryTable">
                						<div class="widget">
                							<div class="widget-header ">
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="cASummaryGraph">
                						<div class="widget">
                							<div class="widget-header ">
                								<span class="widget-caption">Code Analysis Issue Summary</span>
                								<div class="widget-buttons">
                									<a href="#" id="pdf-btn"><i class="fa fa-file-pdf-o"></i></a>
  													<a href="#" id="xls-btn"><i class="fa fa-file-excel-o"></i></a>
  													<a href="#" id="mail-btn"><i class="fa fa-envelope"></i></a>
                			...
                			<div id="deploymentDiv">
                				<div class="row">
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="deploymentDaywise">
                						<div class="widget">
                							<div class="widget-header ">
                								<span class="widget-caption">Day wise Deployment count</span>
                								<div class="widget-buttons">
                									<a href="#" id="pdf-btn"><i class="fa fa-file-pdf-o"></i></a>
  													<a href="#" id="xls-btn"><i class="fa fa-file-excel-o"></i></a>
  													<a href="#" id="mail-btn"><i class="fa fa-envelope"></i></a>
                					...
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="deploymentEnvironment">
                						<div class="widget">
                							<div class="widget-header ">
                								<span class="widget-caption">Day wise Deployment count on each Environment</span>
                								<div class="widget-buttons">
                									<a href="#" id="pdf-btn"><i class="fa fa-file-pdf-o"></i></a>
  													<a href="#" id="xls-btn"><i class="fa fa-file-excel-o"></i></a>
  													<a href="#" id="mail-btn"><i class="fa fa-envelope"></i></a>
                			...
                			<div id="testingDiv">
                				<div class="row">
                					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="testTrend">
                						<div class="widget">
                							<div class="widget-header ">
		...
		$.get('projectlist', function(response){
			...
			$.each(response,function(i){
				...
				if(response[i] == "${currentProject}")
					var li=$('<li/>').addClass('active').append(a).appendTo(uList);	
				else
